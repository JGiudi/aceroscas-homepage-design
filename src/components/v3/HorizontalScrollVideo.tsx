...
const HorizontalScrollVideo = () => {
  ...
  // Stats counter
  const statProgress = useTransform(scrollYProgress, [0.3, 0.7], [0, 1]);
  ...
  return (
    <section ref={sectionRef} className="relative h-[400vh] bg-foreground">
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        {/* Horizontal scrolling text layers */}
        <div className="absolute inset-0 flex flex-col justify-center pointer-events-none overflow-hidden">
          <motion.div
            ...
            style={{ x: textX }}
          >
            FORJANDO • ACERO • MACIZO • DESDE • 1973
          </motion.div>
          <motion.div
            ...
            style={{ x: textX2 }}
          >
            SAE 1010 • 1045 • 4140 • 8620 • CALIDAD
          </motion.div>
        </div>

        {/* Center content that fades in */}
        <div className="relative z-10 h-full flex items-center justify-center">
          <motion.div
            className="text-center max-w-4xl px-8"
            style={{
              opacity: useTransform(scrollYProgress, [0.2, 0.4, 0.6, 0.8], [0, 1, 1, 0]),
              y: useTransform(scrollYProgress, [0.2, 0.4, 0.6, 0.8], [60, 0, 0, -60]),
            }}
          >
        ...
        <motion.div
          ...
          style={{
            opacity: useTransform(scrollYProgress, [0.5, 0.65, 0.9, 1], [0, 1, 1, 0]),
          }}
        >
